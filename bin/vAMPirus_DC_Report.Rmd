...
ptotal <- ptotal %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
ptotal
```
<br>
...
pr <- pr %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
pr
```
<br>
<br>
...
prerp <- prerp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
prerp
```
...
postrp <- postrp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
postrp
```
...
precp <- precp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
precp
```
...
postcp <- postcp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
postcp
```
...
preqp <- preqp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
preqp
```
...
postqp <- postqp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
postqp
```
...
pregcp <- pregcp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
pregcp
```
...
postgcp <- postgcp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
postgcp
```
...
preaqp <- preaqp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
preaqp
```
...
postaqp <- postaqp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
postaqp
```
...
prelhp <- prelhp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
prelhp
```
...
postlhp <- postlhp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
postlhp
```
...
### Number of ncASVs per clustering percentage
...
nnp <- nnp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
nnp
```
...
pnp <- pnp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
pnp
```
