...
mplotbox <- plot_ly(med_asv, y=med_asv$Shannons_Entropy, type="box", boxmean='sd', boxpoints="outlier", jitter=0.1, pointpos=0, name="ASVs")
mplotbox<- mplotbox %>% add_trace(med_amino, y=med_amino$Shannons_Entropy, type="box", boxmean='sd', boxpoints="outliers", jitter=0.1, pointpos=0, name="AminoTypes")
