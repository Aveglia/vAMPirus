...
params:
  ...
  preFilt_gcContent: !r commandArgs(trailingOnly=T)[9]
  postFilt_gcContent: !r commandArgs(trailingOnly=T)[10]
  preFilt_averageQuality: !r commandArgs(trailingOnly=T)[11]
  postFilt_averageQuaulity: !r commandArgs(trailingOnly=T)[12]
  preFilt_length: !r commandArgs(trailingOnly=T)[13]
  postFilt_length: !r commandArgs(trailingOnly=T)[14]
  number_per_percentage_nucl: !r commandArgs(trailingOnly=T)[15]
  number_per_percentage_prot: !r commandArgs(trailingOnly=T)[16]
...
<br>
<br>
<div class="rectangle"><h2 style="color:white">&nbsp;&nbsp;Read Stats</h2></div>
...
<div class="rectangle"><h2 style="color:white">&nbsp;&nbsp;Counts plot</h2></div>
...
#tfil="CHOR"
h <- data5 %>%
  filter(treatment == tfil) ##variable needed to be defined by config
writeLines(c("Mean"))
mean(h$sum)
writeLines(c("Min"))
min(h$sum)
...
<div class="rectangle"><h2 style="color:white">&nbsp;&nbsp;Diversity plots</h2></div>
...
<div class="rectangle"><h2 style="color:white">&nbsp;&nbsp;Distance</h2></div>
...
<div class="rectangle"><h2 style="color:white">&nbsp;&nbsp;NMDS2D</h2></div>
...
<div class="rectangle"><h2 style="color:white">&nbsp;&nbsp;NMDS3D</h2></div>
...
<div class="rectangle"><h2 style="color:white">&nbsp;&nbsp;Sample OTU barplot</h2></div>
...
ddd <- ddd %>% layout(yaxis=list(title = "Reads"))
...
<div class="rectangle"><h2 style="color:white">&nbsp;&nbsp;ASV barplot</h2></div>
...
<div class="rectangle"><h2 style="color:white">&nbsp;&nbsp;Heatmap</h2></div>
...
<div class="rectangle"><h2 style="color:white">&nbsp;&nbsp;Taxonomy</h2></div>
