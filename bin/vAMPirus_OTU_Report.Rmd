---
title: "vAMPirus OTU Report `!r commandArgs(trailingOnly=T)[1]`"
...
```{r logo_plot, echo=FALSE}
#knitr::include_graphics("vamp_logo.png")
```
...
NOTE: Most plots are interactive and you can use the legend to specify samples/treament of interest
