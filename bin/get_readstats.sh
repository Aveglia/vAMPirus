...
echo "Sample,Total_before,R1_before,R1_before_length,R2_before,R2_before_length,GC_before,Total_after,R1_after,R1_after_length,R2_after,R2_after_length,GC_after,Reads_discarded" >${sampleid}_reads_stats.csv
