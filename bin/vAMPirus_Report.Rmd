...
if (params$skipPhylogeny == "true") {
    ...
    #}
    if ((params$asvMED == "true" || params$aminoMED == "true") && (params$type == "ASVs" || params$type == "AminoType")) {
...
```{bash bash_med_table, echo=FALSE}
...
if (params$aminoMED == "true" && params$type == "AminoTypes"){
  writeLines("\n--------------------------------------------------------------\n")
...
if (params$skipPhylogeny == "true") {
    ...
    cat(readLines(list.files(pattern="tree.txt")) , sep = '\n')
    writeLines("\n--------------------------------------------------------------\n")
} else if ((params$asvMED == "true" || params$aminoMED == "true") && (params$type == "ASVs" || params$type == "AminoType")) {
    #tree=read.newick("vAMPrun_otu.55.raxml.support")
