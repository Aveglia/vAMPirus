...
params:
    ...
    deseq: |r commandArgs(trailingOnly=T)[17]
    compare: |r commandArgs(trailingOnly=T)[18]
---
<style>
.rectangle {
  height: 37px;
...
if ( ncol(comp) == 2 ) {
  ...
  metaData$treatment <- factor(metaData$treatment, levels= c("comp$V1","comp$V2","comp$V3","comp$V4","comp$V5","comp$V6","comp$V8"))
} else if (ncol(comp) == 9) {
  metaData$treatment <- factor(metaData$treatment, levels= c("comp$V1","comp$V2","comp$V3","comp$V4","comp$V5","comp$V6","comp$V8","comp$V9"))
} else if (ncol(comp) == 10) {
  metaData$treatment <- factor(metaData$treatment, levels= c("comp$V1","comp$V2","comp$V3","comp$V4","comp$V5","comp$V6","comp$V8","comp$V9","comp$V10"))
} else if (ncol(comp) == 11) {
  metaData$treatment <- factor(metaData$treatment, levels= c("comp$V1","comp$V2","comp$V3","comp$V4","comp$V5","comp$V6","comp$V8","comp$V9","comp$V10","comp$V11"))
} else if (ncol(comp) == 12) {
  metaData$treatment <- factor(metaData$treatment, levels= c("comp$V1","comp$V2","comp$V3","comp$V4","comp$V5","comp$V6","comp$V8","comp$V9","comp$V10","comp$V11","comp$V12"))
}
