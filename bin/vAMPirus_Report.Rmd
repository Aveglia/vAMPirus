...
ddsraw <- DESeqDataSetFromMatrix(countData=round(countData), colData=metaData, design=~treatment, tidy = TRUE)
ddsraw <- DESeq(dds)
...
metaData <- read.csv('params$metadata', header = TRUE, sep = ",")
comp <- read.csv('co mpare.csv', header = FALSE, sep = ",")
