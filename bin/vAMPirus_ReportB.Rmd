...
con <- con %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
con
```
<br>
<br>
...
sh <- sh %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
sh
...
s <- s %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
s
...
ri <- ri %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
ri
...
cen <- cen %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
cen
...
fff <- fff %>% layout(legend=list(y=.5))
fff <- fff %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
fff
...
p3d <- p3d %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
p3d
...
ddd <- ddd %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
ddd
```
<br>
<br>
...
asp2 <- asp2 %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
asp2
```
<br>
<br>
...
tp <- tp %>% config(toImageButtonOptions=list(format='svg',filename='custom_image', height= 500, width= 800, scale= 1))
tp
```
