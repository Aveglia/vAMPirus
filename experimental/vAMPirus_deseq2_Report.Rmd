...
#countData <- read.csv('counts.csv', header = TRUE)
countData <- read.csv('C:/Users/alexv/My Drive/Alex_Veglia/RICE/vAMPirus/testingdeseq/counts.csv', header = TRUE, sep = ",", check.names=FALSE)
#comp <- read.csv('compare.csv', header = FALSE, sep = ",")
comp <- read.csv('C:/Users/alexv/My Drive/Alex_Veglia/RICE/vAMPirus/testingdeseq/compare.csv', header = FALSE, sep = ",")
#metaData <- read.csv('params$metadata', header = TRUE, sep = ",")
metaData <- read.csv('C:/Users/alexv/My Drive/Alex_Veglia/RICE/vAMPirus/testingdeseq/rna_virus_meta.csv', header = TRUE, sep = ",")
if ( ncol(comp) == 2 ) {
